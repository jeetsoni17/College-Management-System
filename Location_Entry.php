...
?>
    <div class="panel panel-default">
  		<div class="panel-heading"><h1><span class="glyphicon glyphicon-globe"></span> Announcement type Update Form</h1></div>
  			<div class="panel-body">
			<div class="container">
				<p style="text-align:center;">Here, you'll update your Announcement records into database.</p>
			</div>
                  <form method="post">    
...
<div class="panel panel-default">
  		<div class="panel-heading"><h1><span class="glyphicon glyphicon-globe"></span> Announcement type Entry Form</h1></div>
  			<div class="panel-body">
			<div class="container">
				<p style="text-align:center;">Here, you'll add your Announcement type records into database.</p>
			</div>
                  <form method="post">    
                      
                      <div class="teacher_note_pos">
                        <input class="form-control" type="text" name="locationtxt" id="textbox" placeholder='Announcement type name' />
                      </div><br>
