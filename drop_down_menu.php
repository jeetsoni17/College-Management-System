...
<!--first button-->
				...
				<div class="btn-group">
  				...
  				<ul class="dropdown-menu" role="menu">
  				  <li><a href="?tag=attendence_entry">Attendence Entry</a></li>
  				  <li><a href="?tag=view_attendence">View Attendence</a></li>
  				</ul>
				</div>
				...
				<div class="btn-group">
  					<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-align-justify"></span>
  					  Announcement <span class="caret"></span>
  					</button>
  				<ul class="dropdown-menu" role="menu">
  				  <li><a href="?tag=artical_entry">Announcement Entry</a></li>
            
  				  <li><a href="?tag=view_artical">View Announcement</a></li>
  				</ul>
				</div>
