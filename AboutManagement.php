...
<html>
    <head>
        ...
        <title>This project is develope by SAKEC CE Students</title>
    </head>
    <body>
        <div class="panel panel-default">
			...
			<div class="container">
				<p style="text-align:center;"></p>
                        ...
                        <h1><strong>Made by: </strong>Jeet, Harsh, Ferzin, Brijesh</h1>
                        <h1><strong>College: </strong>Shah and anchor Engineering College</h1>
