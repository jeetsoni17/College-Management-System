    ...
    <div class="panel panel-default">
  		<div class="panel-heading"><h1><span class="glyphicon glyphicon-star-empty"></span> Score's Entry Form</h1></div>
            ...
            <div class="teacher_bday_box" style="margin-left: 0px;">
                ...
                <div class="teacher_note_pos">
                	<input class="form-control" type="number" name="midermtxt" id="textbox" placeholder='Internal Assesment Average' />
                </div><br>
                ...
                <div class="text_box_pos">
                	<textarea name="notetxt" cols="23" class="form-control" rows="3" placeholder='Add Remarks...'></textarea>
                </div><br><br>
