...
<table class="table table-bordered">
	...
	if($key !="")
        $sql_sel=mysqli_query($conn,"SELECT stu_score_tbl.*, facuties_tbl.faculties_name, sub_tbl.sub_name from stu_score_tbl join facuties_tbl using(faculties_id) join sub_tbl using(sub_id) where stu_id  like '%$key%'");
        ...
        $sql_sel=mysqli_query($conn,"SELECT stu_score_tbl.*, facuties_tbl.faculties_name, sub_tbl.sub_name from stu_score_tbl join facuties_tbl using(faculties_id) join sub_tbl using(sub_id);");
