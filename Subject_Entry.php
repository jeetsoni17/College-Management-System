...
<div class="teacher_bday_box" style="margin-left: 0px;">
            ...
            <div class="teacher_bday_box" style="margin-left: 0px;">
                ...
                <div class="teacher_note_pos">
                	<input type="number" class="form-control" name="semestertxt" id="textbox" placeholder="Semester" />
                </div><br>
                ...
                <div class="text_box_pos">
                	<textarea class="form-control" name="notetxt" cols="23" rows="3" placeholder='Add subject discription'></textarea>
                </div><br><br>
