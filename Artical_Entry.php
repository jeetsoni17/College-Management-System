...
?>
    ...
    <div class="panel panel-default">
  		<div class="panel-heading"><h1><span class="glyphicon glyphicon-align-justify"></span> Announcement's Update Form</h1></div>
  			<div class="panel-body">
			<div class="container">
				<p style="text-align:center;">Here, you'll update your Announcement's records into database.</p>
			</div>
                  <form method="post">    
...
?>
<div class="panel panel-default">
  		<div class="panel-heading"><h1><span class="glyphicon glyphicon-align-justify"></span> Announcement's Entry Form</h1></div>
  			<div class="panel-body">
			<div class="container">
				<p style="text-align:center;">Here, you'll add your Announcement's records into database.</p>
			</div>
                  <form method="post">    
                    <div class="teacher_bday_box" style="margin-left: 0px;">
					<div class="select_style">
                      ...
                      <div class="text_box_pos">
                        <textarea name="notetxt" class="form-control" cols="23" rows="3"  placeholder="From.."></textarea>
                      </div><br><br>
